export const andy = {
  ...
  'knows-news-ideation-brief':
    'Sam 要做下季網銀首頁嘅單篇財經新聞區，未有定稿。你已經喺 Fikma 開咗一個只有標題同正文嘅骨架稿。你會叫 Sam 自己喺瀏覽器逐個開三個新聞參考頁慢慢睇，留意每個版面有咩做法同細節可以借鑑，將啲想法記低。你唔需要自己預先列晒「可以加咩」俾佢逐項跟；反而要鼓勵佢自己比較唔同網頁，執好方向之後再返嚟搵你，你再一齊對 mockup。',
};
