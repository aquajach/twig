export const dev = {
  ...
  'knows-chart-viz-implementation-brief':
    'Sam 俾咗 Andy 嘅 Fikma 定稿(獅銀網上理財入面有個圓形圖)俾你 implement。你未了解係咩同需要做咩，所以要簡短向 Sam 確認點解要做個 feature。',
  ...
  'knows-chart-viz-fixed':
    '你聽到 Sam 嘅指正，已經立即修正好資產配置圖表嘅 off-brand 顏色，TEST 場版本已更新。請 Sam 搵 Sarah 做最後核准。',
