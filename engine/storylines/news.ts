...
export const news: StorylineGraph = {
  ...
  nodes: {
    ...
    "evt-intent-andy-ticker": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add a stock ticker or related symbol link to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: -780,
    ...
    "evt-intent-andy-chart": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add a small inline price or performance chart to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: -525,
    ...
    "evt-intent-andy-reactions": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add reaction buttons or emoji reactions to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: -270,
    ...
    "evt-intent-andy-comments": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add a comment section or comment thread to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: -15,
    ...
    "evt-intent-andy-author": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add an author byline or author line to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: 255,
    ...
    "evt-intent-andy-tags": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add category tags or topic chips to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: 510,
    ...
    "evt-intent-andy-share": {
      ...
      npcId: "andy",
      statementText:
        "Player asks Andy to add a share button to the news article mockup.",
      enabledBy: ["step-news-design-open"],
      layout: {
        x: 825,
        y: 765,
    ...
    "memo-news-brainstorm": {
      ...
      memo: {
        ...
        title: "集思廣益",
        description:
          "設計了使用所有參考元素，涵蓋日期、股票連結、圖表、反應、留言、作者、標籤與分享。",
        icon: "💡",
      },
      layout: {
        x: 2265,
